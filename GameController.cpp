...
GameController::GameController(int columns, int rows)
{
    ...
    m_HeadlineCyan = TextView::MakeText(48.0f, 22.0f, 75.0f, "Tron", "C0nnect F0ur", ColorPalette::Cyan);
    m_HeadlineOrange = TextView::MakeText(52.0f, 26.0f, 75.0f, "Tron", "C0nnect F0ur", ColorPalette::Orange);
